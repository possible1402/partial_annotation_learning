...
def allowed_transitions(
    ...
    if include_start_stop:
        labels_with_boundaries.extend([(start_tag, "START"), (end_tag, "END")]) # 是否添加start和end，这里是false，并没有添加
    ...
    return allowed # 得到的是一个0，1的矩阵，大小为num_labels*num_labels,其实是transition矩阵，代表是否允许从一个标签跳转到另一个标签
